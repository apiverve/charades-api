# Charades Generator API - Examples

This folder contains example code for using the Charades Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/charades',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/charades");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/charades](https://docs.apiverve.com/ref/charades)
