# Charades Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:charades-api:1.1.12'
}
```
...
```java
import com.apiverve.charades.CharadesGeneratorAPIClient;
import com.apiverve.charades.APIResponse;
import com.apiverve.charades.APIException;

// Initialize the client
CharadesGeneratorAPIClient client = new CharadesGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/charades](https://docs.apiverve.com/ref/charades)
...
- **Documentation:** [https://docs.apiverve.com/ref/charades](https://docs.apiverve.com/ref/charades)
- **Issues:** [GitHub Issues](https://github.com/apiverve/charades-api/issues)
