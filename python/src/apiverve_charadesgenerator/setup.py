...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/charades',
        'Source': 'https://github.com/apiverve/charades-api',
        'Bug Tracker': 'https://github.com/apiverve/charades-api/issues'
    },
    classifiers=[
