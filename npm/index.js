...
class charadesWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/charades');
        }
        ...
        this.validationRules = {"category":{"type":"string","required":false,"default":"all"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/charades`);
        }
    }
...
module.exports = charadesWrapper;
