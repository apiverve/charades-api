// Package charades provides a Go client for the Charades Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/charades?utm_source=go&utm_medium=readme
package charades
...
const (
	baseURL        = "https://api.apiverve.com/v1/charades"
	defaultTimeout = 30 * time.Second
)

// Client is the Charades Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Charades Generator API client.
...
// Execute makes a request to the Charades Generator API with typed parameters.
//
...
//   - category: string - Category: all, movies, books, songs, actions, animals, objects
