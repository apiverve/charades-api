...
/**
 * Client for the Charades Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/charades?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/charades';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CharadesClient] {$message}\n";
        }
    }
}
